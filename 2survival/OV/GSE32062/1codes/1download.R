...
setwd("/proj/c.zihao/work1/1survival/OV/GSE32062/data/")
set.seed(1234)
...
exprSet <- as.data.frame(exprs(gse$`GSE32062-GPL6480_series_matrix.txt.gz`))
str(exprSet)
...
pd <- pData(gse$`GSE32062-GPL6480_series_matrix.txt.gz`)
head(pd)
names(pd)
