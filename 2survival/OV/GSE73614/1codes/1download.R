...
setwd("/proj/c.zihao/work1/1survival/OV/GSE73614/data/")
set.seed(1234)
...
exprSet <- as.data.frame(exprs(gse$GSE73614_series_matrix.txt.gz))
str(exprSet)
...
pd <- pData(gse$GSE73614_series_matrix.txt.gz)
head(pd)
names(pd)
