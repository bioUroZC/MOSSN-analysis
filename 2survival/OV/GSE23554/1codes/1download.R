...
setwd("/proj/c.zihao/work1/1survival/OV/GSE23554/data/")
set.seed(1234)
...
exprSet <- as.data.frame(exprs(gse$GSE23554_series_matrix.txt.gz))
str(exprSet)
...
pd <- pData(gse$GSE23554_series_matrix.txt.gz)
head(pd)
names(pd)
