...
setwd("/proj/c.zihao/work1/1survival/OV/GSE17260/data")
set.seed(1234)
...
exprSet <- as.data.frame(exprs(gse$GSE17260_series_matrix.txt.gz))
str(exprSet)
...
pd <- pData(gse$GSE17260_series_matrix.txt.gz)
head(pd)
names(pd)
