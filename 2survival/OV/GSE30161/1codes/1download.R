...
setwd("/proj/c.zihao/work1/1survival/OV/GSE30161/data/")
set.seed(1234)
...
exprSet <- as.data.frame(exprs(gse$GSE30161_series_matrix.txt.gz))
str(exprSet)
...
pd <- pData(gse$GSE30161_series_matrix.txt.gz)
head(pd)
names(pd)
