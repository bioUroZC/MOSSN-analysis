...
# 1. Basic settings
BASE_DIR <- paste0(PROJ_ROOT, "/2survival/OV/")
OUTPUT_DIR <- paste0(PROJ_ROOT, "/2survival/OV/1Matrix")
LINKS_FILE <- paste0(PROJ_ROOT, "/1NT/1data/string/links.csv")


available_datasets <- c("GSE102073", "GSE13876", "GSE17260",
                "GSE26193", "GSE26712", "GSE30161", "GSE31245",
                "GSE32062", "GSE51088", "GSE53963",
