...
# 1. Basic settings
BASE_DIR <- "/proj/c.zihao/work1/2survival/CRC/"
OUTPUT_DIR <- "/proj/c.zihao/work1/2survival/CRC/1Matrix"
LINKS_FILE <- "/proj/c.zihao/work1/1NT/1data/string/links.csv"


available_datasets <- c("ACICAM", "GSE12945", "GSE17536", "GSE17537",
                        "GSE28722", "GSE29621", "GSE39582", "GSE41258",
                        "TCGACRC")
