...
dataset_paths <- list(
  CGGA301 = "/proj/c.zihao/work1/2survival/LGG/CGGA301/data/exprSet.csv",
  CGGA325 = "/proj/c.zihao/work1/2survival/LGG/CGGA325/data/exprSet.csv",
  CGGA693 = "/proj/c.zihao/work1/2survival/LGG/CGGA693/data/exprSet.csv",
  GSE16011 = "/proj/c.zihao/work1/2survival/LGG/GSE16011/data/exprSet.csv",
  MTAB3892 = "/proj/c.zihao/work1/2survival/LGG/MTAB3892/data/exprSet.csv",
  TCGALGG = "/proj/c.zihao/work1/2survival/LGG/TCGALGG/data/exprSet.csv"
)
