...
dataset_paths <- list(
  GSE107943 = paste0(PROJ_ROOT, "/2survival/CHOL/GSE107943/data/exprSet.csv"),
  GSE244807 = paste0(PROJ_ROOT, "/2survival/CHOL/GSE244807/data/exprSet.csv"),
  GSE89748 = paste0(PROJ_ROOT, "/2survival/CHOL/GSE89748/data/exprSet.csv"),
  MTAB6389 = paste0(PROJ_ROOT, "/2survival/CHOL/MTAB6389/data/exprSet.csv"),
  TCGACHOL = paste0(PROJ_ROOT, "/2survival/CHOL/TCGACHOL/data/exprSet.csv")
)
