...
dataset_paths <- list(
  GSE107943 = "/proj/c.zihao/work1/2survival/CHOL/GSE107943/data/exprSet.csv",
  GSE244807 = "/proj/c.zihao/work1/2survival/CHOL/GSE244807/data/exprSet.csv",
  GSE89748 = "/proj/c.zihao/work1/2survival/CHOL/GSE89748/data/exprSet.csv",
  MTAB6389 = "/proj/c.zihao/work1/2survival/CHOL/MTAB6389/data/exprSet.csv",
  TCGACHOL = "/proj/c.zihao/work1/2survival/CHOL/TCGACHOL/data/exprSet.csv"
)
