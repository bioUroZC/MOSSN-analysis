...
dataset_paths <- list(
  GSE13507 = "/proj/c.zihao/work1/2survival/BLCA/GSE13507/data/exprSet.csv",
  GSE31684 = "/proj/c.zihao/work1/2survival/BLCA/GSE31684/data/exprSet.csv",
  GSE32894 = "/proj/c.zihao/work1/2survival/BLCA/GSE32894/data/exprSet.csv",
  GSE48276 = "/proj/c.zihao/work1/2survival/BLCA/GSE48276/data/exprSet.csv",
  TCGABLCA = "/proj/c.zihao/work1/2survival/BLCA/TCGABLCA/data/exprSet.csv"
)
