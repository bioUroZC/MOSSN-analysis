...
# 1. Basic settings
BASE_DIR <- "/proj/c.zihao/work1/2survival/LUAD/"
OUTPUT_DIR <- "/proj/c.zihao/work1/2survival/LUAD/1Matrix"
LINKS_FILE <- "/proj/c.zihao/work1/1NT/1data/string/links.csv"


available_datasets <- c("GSE30219", "GSE31210", "GSE41271", "GSE42127", "GSE50081",
