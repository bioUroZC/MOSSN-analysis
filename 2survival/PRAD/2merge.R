...
# 1. Basic settings
BASE_DIR <- "/proj/c.zihao/work1/2survival/PRAD/"
OUTPUT_DIR <- "/proj/c.zihao/work1/2survival/PRAD/1Matrix"
LINKS_FILE <- "/proj/c.zihao/work1/1NT/1data/string/links.csv"


available_datasets <- c("DKFZ2018", "GSE116918", "GSE21034", "GSE46602",
