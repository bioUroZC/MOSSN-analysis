...
dataset_paths <- list(
  CPTAC = "/proj/c.zihao/work1/2survival/KIRC/CPTAC/data/exprSet.csv",
  GSE167573 = "/proj/c.zihao/work1/2survival/KIRC/GSE167573/data/exprSet.csv",
  MATB1980 = "/proj/c.zihao/work1/2survival/KIRC/MATB1980/data/exprSet.csv",
  PCWAG = "/proj/c.zihao/work1/2survival/KIRC/PCWAG/data/exprSet.csv",
  TCGAKIRC = "/proj/c.zihao/work1/2survival/KIRC/TCGAKIRC/data/exprSet.csv"
)
