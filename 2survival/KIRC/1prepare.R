...
dataset_paths <- list(
  CPTAC = paste0(PROJ_ROOT, "/2survival/KIRC/CPTAC/data/exprSet.csv"),
  GSE167573 = paste0(PROJ_ROOT, "/2survival/KIRC/GSE167573/data/exprSet.csv"),
  PCWAG = paste0(PROJ_ROOT, "/2survival/KIRC/PCWAG/data/exprSet.csv"),
  TCGAKIRC = paste0(PROJ_ROOT, "/2survival/KIRC/TCGAKIRC/data/exprSet.csv")
)
