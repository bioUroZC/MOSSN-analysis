...
# 1. Basic settings
BASE_DIR <- "/proj/c.zihao/work1/2survival/KIRC/"
OUTPUT_DIR <- "/proj/c.zihao/work1/2survival/KIRC/1Matrix"
LINKS_FILE <- "/proj/c.zihao/work1/1NT/1data/string/links.csv"


available_datasets <- c("CPTAC", "GSE167573", "MATB1980", "PCWAG", "TCGAKIRC")
