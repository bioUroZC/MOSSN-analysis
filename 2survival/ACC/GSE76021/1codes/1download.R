...
setwd("/proj/c.zihao/work1/1survival/ACC/GSE76021/data/")
...
exprSet <- as.data.frame(exprs(gse$GSE76021_series_matrix.txt.gz))
str(exprSet)
...
pd <- pData(gse$GSE76021_series_matrix.txt.gz)
head(pd)
names(pd)
