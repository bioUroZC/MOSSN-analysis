...
setwd("/proj/c.zihao/work1/1survival/ACC/GSE10927/data/")
...
exprSet <- as.data.frame(exprs(gse$GSE10927_series_matrix.txt.gz))
str(exprSet)
...
pd <- pData(gse$GSE10927_series_matrix.txt.gz)
head(pd)
