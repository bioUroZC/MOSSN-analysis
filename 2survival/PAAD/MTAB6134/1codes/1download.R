...
setwd("/proj/c.zihao/work1/1survival/PAAD/MTAB6134/data/")

#=======================================================

#=======================================================

exprSet <- fread("ProcessedExpression.tsv")
...
pd <- read.table("https://ftp.ebi.ac.uk/biostudies/fire/E-MTAB-/134/E-MTAB-6134/Files/E-MTAB-6134.sdrf.txt",
...
colnames(pd) <- c("Sample", "Gender", "Stage", "OS", "OS_Time")
