...
# 1. Basic settings
BASE_DIR <- "/proj/c.zihao/work1/2survival/PAAD/"
OUTPUT_DIR <- "/proj/c.zihao/work1/2survival/PAAD/1Matrix"
LINKS_FILE <- "/proj/c.zihao/work1/1NT/1data/string/links.csv"


available_datasets <- c("CPTAC", "GSE28735", "GSE62452", "GSE71729", "GSE79668",
                        "GSE85916", "MTAB6134", "QCMG", "TCGAPAAD")
