...
dataset_paths <- list(
  CPTAC     = paste0(PROJ_ROOT, "/2survival/PAAD/CPTAC/data/exprSet.csv"),
  GSE28735  = paste0(PROJ_ROOT, "/2survival/PAAD/GSE28735/data/exprSet.csv"),
  GSE62452  = paste0(PROJ_ROOT, "/2survival/PAAD/GSE62452/data/exprSet.csv"),

  GSE71729  = paste0(PROJ_ROOT, "/2survival/PAAD/GSE71729/data/exprSet.csv"),
  GSE79668  = paste0(PROJ_ROOT, "/2survival/PAAD/GSE79668/data/exprSet.csv"),
  GSE85916  = paste0(PROJ_ROOT, "/2survival/PAAD/GSE85916/data/exprSet.csv"),
  MTAB6134  = paste0(PROJ_ROOT, "/2survival/PAAD/MTAB6134/data/exprSet.csv"),

  QCMG      = paste0(PROJ_ROOT, "/2survival/PAAD/QCMG/data/exprSet.csv"),
  TCGAPAAD  = paste0(PROJ_ROOT, "/2survival/PAAD/TCGAPAAD/data/exprSet.csv")
)
