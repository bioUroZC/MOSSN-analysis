...
setwd("/proj/c.zihao/work1/1survival/BRCA/GSE11121/data")
...
exprSet <- as.data.frame(exprs(gse$GSE11121_series_matrix.txt.gz))
str(exprSet)
...
pd <- pData(gse$GSE11121_series_matrix.txt.gz)
head(pd)
names(pd)
