...
setwd("/proj/c.zihao/work1/1survival/BRCA/GSE12093/data")
...
exprSet <- as.data.frame(exprs(gse$GSE12093_series_matrix.txt.gz))
str(exprSet)
...
pd <- pData(gse$GSE12093_series_matrix.txt.gz)
head(pd)
names(pd)
