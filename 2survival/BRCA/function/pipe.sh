#!/bin/bash -l
#SBATCH -J BRCA_survival_func
#SBATCH -p CPU
#SBATCH -N 1
#SBATCH --cpus-per-task=8
#SBATCH --mem=40G
#SBATCH --array=0-7%8
#SBATCH -o /proj/c.zihao/work1/2survival/BRCA/function/logs/pipe_%A_%a.out
#SBATCH -e /proj/c.zihao/work1/2survival/BRCA/function/logs/pipe_%A_%a.err

set -euo pipefail

PYBIN="$HOME/.conda/envs/work1/bin/python"
DIR="/proj/c.zihao/work1/2survival/BRCA/function"
