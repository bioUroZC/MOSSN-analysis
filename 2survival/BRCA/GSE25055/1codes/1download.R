...
setwd("/proj/c.zihao/work1/1survival/BRCA/GSE25055/data")
...
exprSet <- as.data.frame(exprs(gse$GSE25055_series_matrix.txt.gz))
str(exprSet)
...
pd <- pData(gse$GSE25055_series_matrix.txt.gz)
head(pd)
names(pd)
