...
setwd("/proj/c.zihao/work1/1survival/BRCA/GSE21653/data")
...
exprSet <- as.data.frame(exprs(gse$GSE21653_series_matrix.txt.gz))
str(exprSet)
...
pd <- pData(gse$GSE21653_series_matrix.txt.gz)
head(pd)
names(pd)
