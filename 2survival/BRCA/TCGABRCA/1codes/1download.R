...
exprdir <- '/proj/c.zihao/work1/1survival/BRCA/TCGABRCA/data/'
surdir <- "/proj/c.zihao/work1/1survival/"
cancername <- "BRCA"
...
survivaldata <- subset(survivaldata, select = c("bcr_patient_barcode", "type",
                                                "ajcc_pathologic_tumor_stage",
                                                "PFI", "PFI.time"))
names(survivaldata) <- c("Sample", "cancertype", "Stage", "EFS", "EFS_Time")
...
survivaldata$EFS_Time <- survivaldata$EFS_Time / 365
pd <- survivaldata
