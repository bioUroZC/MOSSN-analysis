...
dataset_paths <- list(
  GSE14520 = paste0(PROJ_ROOT, "/2survival/LIHC/GSE14520/data/exprSet.csv"),
  GSE54236 = paste0(PROJ_ROOT, "/2survival/LIHC/GSE54236/data/exprSet.csv"),
  GSE116174 = paste0(PROJ_ROOT, "/2survival/LIHC/GSE116174/data/exprSet.csv"),
  GSE144269 = paste0(PROJ_ROOT, "/2survival/LIHC/GSE144269/data/exprSet.csv"),
  ICGC = paste0(PROJ_ROOT, "/2survival/LIHC/ICGC/data/exprSet.csv"),
  TCGALIHC = paste0(PROJ_ROOT, "/2survival/LIHC/TCGALIHC/data/exprSet.csv")
)
