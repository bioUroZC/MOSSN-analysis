...
dataset_paths <- list(
  GSE15459 = paste0(PROJ_ROOT, "/2survival/STAD/GSE15459/data/exprSet.csv"),
  GSE26253 = paste0(PROJ_ROOT, "/2survival/STAD/GSE26253/data/exprSet.csv"),
  GSE26899 = paste0(PROJ_ROOT, "/2survival/STAD/GSE26899/data/exprSet.csv"),
  
  GSE26901 = paste0(PROJ_ROOT, "/2survival/STAD/GSE26901/data/exprSet.csv"),
  GSE29272 = paste0(PROJ_ROOT, "/2survival/STAD/GSE29272/data/exprSet.csv"),
  GSE57303 = paste0(PROJ_ROOT, "/2survival/STAD/GSE57303/data/exprSet.csv"),
  GSE62254 = paste0(PROJ_ROOT, "/2survival/STAD/GSE62254/data/exprSet.csv"),
  GSE84437 = paste0(PROJ_ROOT, "/2survival/STAD/GSE84437/data/exprSet.csv"),

  TCGASTAD = paste0(PROJ_ROOT, "/2survival/STAD/TCGASTAD/data/exprSet.csv")
)
