...
setwd("/proj/c.zihao/work1/1survival/GBM/GSE83300/data")
...
exprSet <- as.data.frame(exprs(gse$GSE83300_series_matrix.txt.gz))
str(exprSet)
...
pd <- pData(gse$GSE83300_series_matrix.txt.gz)
head(pd)
names(pd)
