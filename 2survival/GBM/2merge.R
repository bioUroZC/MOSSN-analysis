...
# 1. Basic settings
BASE_DIR <- "/proj/c.zihao/work1/2survival/GBM/"
OUTPUT_DIR <- "/proj/c.zihao/work1/2survival/GBM/1Matrix"
LINKS_FILE <- "/proj/c.zihao/work1/1NT/1data/string/links.csv"


available_datasets <- c("CGGA301", "CGGA325", "CGGA693", "GSE4412", "GSE13041",
                        "GSE16011", "GSE72951", "GSE74187", "GSE83300", "TCGAGBM")
