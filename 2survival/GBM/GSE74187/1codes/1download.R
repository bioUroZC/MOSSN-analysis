...
setwd("/proj/c.zihao/work1/1survival/GBM/GSE74187/data")
...
exprSet <- as.data.frame(exprs(gse$GSE74187_series_matrix.txt.gz))
str(exprSet)
...
pd <- pData(gse$GSE74187_series_matrix.txt.gz)
head(pd)
names(pd)
