...
dataset_paths <- list(
  CGGA301 = paste0(PROJ_ROOT, "/2survival/GBM/CGGA301/data/exprSet.csv"),
  CGGA325 = paste0(PROJ_ROOT, "/2survival/GBM/CGGA325/data/exprSet.csv"),
  CGGA693 = paste0(PROJ_ROOT, "/2survival/GBM/CGGA693/data/exprSet.csv"),
  GSE13041 = paste0(PROJ_ROOT, "/2survival/GBM/GSE13041/data/exprSet.csv"),

  GSE16011 = paste0(PROJ_ROOT, "/2survival/GBM/GSE16011/data/exprSet.csv"),
  GSE4412 = paste0(PROJ_ROOT, "/2survival/GBM/GSE4412/data/exprSet.csv"),
  GSE72951 = paste0(PROJ_ROOT, "/2survival/GBM/GSE72951/data/exprSet.csv"),
  GSE74187 = paste0(PROJ_ROOT, "/2survival/GBM/GSE74187/data/exprSet.csv"),

  TCGAGBM = paste0(PROJ_ROOT, "/2survival/GBM/TCGAGBM/data/exprSet.csv")
)
