...
#SBATCH --mem=30G
#SBATCH --array=0-4
#SBATCH -o /proj/c.zihao/work1/1NT/2biogrid/logs/MOSSN_%A_%a.out
#SBATCH -e /proj/c.zihao/work1/1NT/2biogrid/logs/MOSSN_%A_%a.err
...
# --array=0-4 must stay in sync with this array (5 entries)
SCRIPTS=(
