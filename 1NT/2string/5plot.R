...
base_dir <- "/proj/c.zihao/work1/1NT/2string/1distance"
...
ggsave(file.path(out_dir, "heatmap_auc.pdf"), p_auc,
       width = 8.5, height = 4.2)
...
ggsave(file.path(out_dir, "line_auc.pdf"), p_line_auc,
       width = 6, height = 4)
ggsave(file.path(out_dir, "line_accuracy.pdf"), p_line_acc,
       width = 6, height = 4)
