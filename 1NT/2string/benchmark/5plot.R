...
ggsave(file.path(out_dir, "Bench_heatmap_accuracy.pdf"), p_acc,
       width = 8.5, height = 4.2)
ggsave(file.path(out_dir, "Bench_heatmap_auc.pdf"), p_auc,
       width = 8.5, height = 4.2)
...
ggsave(file.path(out_dir, "Bench_line_auc.pdf"), p_line_auc,
       width = 6, height = 4)
ggsave(file.path(out_dir, "Bench_line_accuracy.pdf"), p_line_acc,
       width = 6, height = 4)
