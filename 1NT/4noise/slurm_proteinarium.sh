#!/bin/bash -l
#SBATCH -J 4noise_proteinarium
#SBATCH -N 1
#SBATCH --cpus-per-task=6
#SBATCH --mem=30G
#SBATCH --array=0-3%4
#SBATCH -o /proj/c.zihao/work1/1NT/4noise/logs/proteinarium_%A_%a.out
#SBATCH -e /proj/c.zihao/work1/1NT/4noise/logs/proteinarium_%A_%a.err
