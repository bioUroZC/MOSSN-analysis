...
#SBATCH --mem=30G
#SBATCH --array=0-12%8
#SBATCH -o logs/pipe_%A_%a.out
#SBATCH -e logs/pipe_%A_%a.err

set -euo pipefail

PYBIN="$HOME/.conda/envs/work1/bin/python"
DIR="/proj/c.zihao/work1/1NT/2HuRI"
...
SCRIPTS=(
    ...
    "$DIR/cal_MOSS_noPrior.py"
    "$DIR/cal_MOSS_noSeed.py"
    "$DIR/cal_MOSS_noRWR.py"
    "$DIR/cal_MOSS_baseline.py"
    "$DIR/cal_MOSS_uniform.py"
    "$DIR/cal_MOSS_noCorr.py"
    "$DIR/cal_Patkar.py"
