...
#SBATCH --mem=30G
#SBATCH --array=0-7%8
#SBATCH -o /proj/c.zihao/work1/1NT/3robust/10/logs/pipe_%A_%a.out
#SBATCH -e /proj/c.zihao/work1/1NT/3robust/10/logs/pipe_%A_%a.err

set -euo pipefail

PYBIN="$HOME/.conda/envs/work1/bin/python"
DIR="/proj/c.zihao/work1/1NT/3robust/10"
