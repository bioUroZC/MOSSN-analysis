...
This folder reruns the `2matrix` workflow on a fixed 10% subset of `LUAD` samples and compares the subset results against the original full-sample `2matrix` results.
