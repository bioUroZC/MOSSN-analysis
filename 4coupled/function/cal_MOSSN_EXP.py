"""MOSSN_EXP: single-layer RWR on expression (beta=1, no coupling)."""
...
OUT_ROOT  = "/proj/c.zihao/work1/4coupled/results/MOSSN_EXP"
...
for cancer in CANCERS:
    ...
    omic_data = {"EXP": pd.read_csv(f"{DATA_DIR}/{cancer}_EXP.csv", index_col=0)}
