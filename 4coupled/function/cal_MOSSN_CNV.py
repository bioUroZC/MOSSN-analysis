"""MOSSN_CNV: single-layer RWR on copy number variation."""
...
OUT_ROOT  = "/proj/c.zihao/work1/4coupled/results/MOSSN_CNV"
...
for cancer in CANCERS:
    ...
    omic_data = {"EXP": pd.read_csv(f"{DATA_DIR}/{cancer}_CNV.csv", index_col=0)}
    ...
    for sid in tqdm(omic_data["EXP"].columns, desc=cancer):
        ...
        df["Node1"] = "CNV:" + df["Node1"]
        df["Node2"] = "CNV:" + df["Node2"]
