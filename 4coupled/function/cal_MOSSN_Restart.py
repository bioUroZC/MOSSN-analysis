"""
MOSSN_Restart: restart-coupled comparative variant with dynamic concordance coupling.
coupling_l[g] = importance_l[g] * sigmoid(z_l[g] * z_EXP[g])
This compares direct graph-level integration against restart-level coupling.
"""
...
OUT_ROOT  = "/proj/c.zihao/work1/4coupled/results/MOSSN_Restart"
