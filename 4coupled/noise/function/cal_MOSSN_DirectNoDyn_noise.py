"""MOSSN_DirectNoDyn noise: direct cross-layer model without dynamic weighting, LUAD only."""
...
OUT_ROOT     = "/proj/c.zihao/work1/4coupled/noise/results/MOSSN_DirectNoDyn"
