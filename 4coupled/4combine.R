...
setwd("/proj/c.zihao/work1/2survival")
...
save_dir <- '/proj/c.zihao/work1/4coupled/files'

exp_dir <- '/proj/c.zihao/work1/4coupled/EXPout'

cnv_dir <- '/proj/c.zihao/work1/4coupled/CNVout'

met_dir <- '/proj/c.zihao/work1/4coupled/METout'
