...
dataset_paths <- list(
  GSE104958 = "/proj/c.zihao/work1/3drugs/CisplatinSTAD/GSE104958/data/exprSet.csv",
  GSE225178 = "/proj/c.zihao/work1/3drugs/CisplatinSTAD/GSE225178/data/exprSet.csv"
)
