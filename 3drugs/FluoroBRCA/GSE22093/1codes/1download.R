...
setwd("/proj/c.zihao/work1/3drugs/FluoroBRCA/GSE22093/data")
...
exprSet <- as.data.frame(exprs(gse$GSE22093_series_matrix.txt.gz))
str(exprSet)
...
pd <- pData(gse$GSE22093_series_matrix.txt.gz)
names(pd)
head(pd)

table(pd$`pcr.v.rd:ch1`)
table(pd$`tissue:ch1`)
