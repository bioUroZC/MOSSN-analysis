...
setwd("/proj/c.zihao/work1/3drugs/FluoroBRCA/GSE66305/data")
...
exprSet <- as.data.frame(exprs(gse$GSE66305_series_matrix.txt.gz))
str(exprSet)
...
pd <- pData(gse$GSE66305_series_matrix.txt.gz)
names(pd)
head(pd)
pd <- subset(pd, select=c("geo_accession" , 'pcr (1=yes):ch1'))
