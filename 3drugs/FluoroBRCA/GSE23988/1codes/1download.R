...
setwd("/proj/c.zihao/work1/3drugs/FluoroBRCA/GSE23988/data")
...
exprSet <- as.data.frame(exprs(gse$GSE23988_series_matrix.txt.gz))
str(exprSet)
...
pd <- pData(gse$GSE23988_series_matrix.txt.gz)
names(pd)
head(pd)
