...
setwd("/proj/c.zihao/work1/3drugs/FluoroBRCA/GSE50948/data")
...
exprSet <- as.data.frame(exprs(gse$GSE50948_series_matrix.txt.gz))
str(exprSet)
...
pd <- pData(gse$GSE50948_series_matrix.txt.gz)
names(pd)
head(pd)
...
pd <- subset(pd, select=c("geo_accession" , 'age:ch1', 'pcr:ch1'))
