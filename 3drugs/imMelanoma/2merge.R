...
# 1. Basic settings
BASE_DIR <- "/proj/c.zihao/work1/3drugs/imMelanoma/"
OUTPUT_DIR <- "/proj/c.zihao/work1/3drugs/imMelanoma/1Matrix"
LINKS_FILE <- "/proj/c.zihao/work1/1NT/1data/string/links.csv"


available_datasets <-  c('GSE78220', 'GSE91061', 'GSE100797', 'Nathanson', 'PRJEB23709')
