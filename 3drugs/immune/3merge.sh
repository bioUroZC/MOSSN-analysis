#!/bin/bash -l
#SBATCH -J merge_immune
#SBATCH -N 1
#SBATCH --ntasks-per-node=1
#SBATCH --cpus-per-task=8
#SBATCH --mem=40G
#SBATCH -o /proj/c.zihao/work1/3drugs/immune/logs/merge_%j.out
#SBATCH -e /proj/c.zihao/work1/3drugs/immune/logs/merge_%j.err

set -euo pipefail

DIR="/proj/c.zihao/work1/3drugs/immune"
mkdir -p "$DIR/logs"
cd "$DIR"
